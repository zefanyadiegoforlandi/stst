    ...
    override fun onCreateView(
        ...
        with(binding) {
            btLoginLogin.setOnClickListener {
                if (etLoginPass.text.toString() == "" ||  etLoginUsername.text.toString() == ""){
                    android.widget.Toast.makeText(requireContext(), "Please fill in all fields", android.widget.Toast.LENGTH_SHORT).show()
                }else{
                    val intentToHome = Intent(requireContext(), com.example.mobile_p8_actionbar.tugas.HomePageActivity::class.java)
